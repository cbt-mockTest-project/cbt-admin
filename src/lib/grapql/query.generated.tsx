...
export type ReadMockExamQuestionQuery = {
  ...
  readMockExamQuestion: {
    ...
    mockExamQusetion: {
      ...
      mockExam: { __typename?: 'MockExam'; title: string };
    };
  };
};
...
export type MeQuery = {
  ...
  me: {
    ...
    ok: boolean;
    error?: string | null;
    user?: { __typename?: 'User'; nickname: string } | null;
  };
};
...
export type ReadMockExamQuestionNumbersQuery = {
  __typename?: 'Query';
...
export function useReadMockExamQuestionNumbersQuery(
  options: Omit<
    Urql.UseQueryArgs<ReadMockExamQuestionNumbersQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<
  ...
  >({ query: ReadMockExamQuestionNumbersDocument, ...options });
}
