...
export type ReadAllMockExamQuery = { __typename?: 'Query', readAllMockExam: { __typename?: 'ReadAllMockExamsOutput', mockExams: Array<{ __typename?: 'MockExam', title: string, id: number }> } };
...
export type ReadMockExamQuery = { __typename?: 'Query', readMockExam: { __typename?: 'ReadMockExamOutput', mockExam: { __typename?: 'MockExam', title: string, approved: boolean, mockExamQuestion: Array<{ __typename?: 'MockExamQuestion', question: string, solution: string, id: number, number: number, question_img?: Array<{ __typename?: 'MockExamImageType', url: string }> | null, solution_img?: Array<{ __typename?: 'MockExamImageType', url: string }> | null, mockExamQuestionFeedback: Array<{ __typename?: 'MockExamQuestionFeedback', content: string, id: number }> }> } } };
